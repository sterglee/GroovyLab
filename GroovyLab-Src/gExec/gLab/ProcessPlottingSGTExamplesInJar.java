...
public class ProcessPlottingSGTExamplesInJar  extends JFrame {
...
*/
   ...
   public ProcessPlottingSGTExamplesInJar(String jarFile)
   {
      setTitle("Plotting  Examples -- Copy & Paste in the GroovyLab Editor and then press F9 to run them");
      ...
      examplesLabel.setText("Selected Plotting example: ");
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".javaSGT") || nameOfEntry.endsWith("java-jzy3D")) 
