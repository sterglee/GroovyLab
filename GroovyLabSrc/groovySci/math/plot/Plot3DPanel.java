...
import groovySci.math.plot.utils.*;
...
public class Plot3DPanel extends PlotPanel {
   ...
   public Plot3DPanel(Plot3DPanel [] [] _panels, String legendOrientation) {
   ...
   public Plot3DPanel(String legendOrientation) {
     ...
     * of the data points, second contains the Y position, third contains the Z position.
     * <br>
	...
	public int addBoxPlot(String name, Color c, double[][] XYdX) {
		return ((Plot3DCanvas) plotCanvas).addBoxPlot(name, c, PArray.getColumnsRangeCopy(XYdX, 0, 2), PArray.getColumnsRangeCopy(XYdX, 3, 5));
	}
	...
	public int addHistogramPlot(String name, Color c, double[][] XYdX) {
		return ((Plot3DCanvas) plotCanvas).addHistogramPlot(name, c, PArray.getColumnsRangeCopy(XYdX, 0, 2), PArray.getColumnsRangeCopy(XYdX, 3, 4));
	}
	...
	public int addGridPlot(String name, Color c,  boolean drawLines, boolean fillShape, double[] X, double[] Y, double[][] Z) {
		return ((Plot3DCanvas) plotCanvas).addGridPlot(name, c,  drawLines, fillShape, X, Y, Z);
	}
