...
{  
 ...
 //  static public Future<String> commandFuture = null;  // not used yet!
   ...
   static public GCompletionProvider  providerObject;   // RSyntaxArea completion provider
  ...
  // variables for implementing code completion using Java reflection
   ...
   static public int selectionStart; // index to the start of the text for completion
   static public int selectionEnd;  // index to the end of the text for completion
   ...
   static public Font puifont = new Font(puiFontName, Font.PLAIN, Integer.parseInt(puiFontSize));
    ...
    static public Font guifont = new Font(guiFontName, Font.PLAIN, Integer.parseInt(guiFontSize));
        ...
        static  public String  jLabConsoleFontName = "Times New Roman";
        static  public String  jLabConsoleFontSize = "14";
   ...
   static public boolean pathUpdateOnSaves = false;
    ...
    static public boolean displayAtOutputWindow = false;   // controls displaying at output window
        ...
        static public int debugExprCnt  = 0;  // useful for controlling at which repetition to activate debugging
        static public String currentPropertyProcessed="";
        static public double dynamicMatrixResizeFactor = 1.5; // by how much to increase the size of dynamic matrices
        ...
        public static Evaluator  globalJavaEvaluator;   // the Java repl evaluator
        public static javarepl.client.JavaREPLClient globalJavaREPLCLient;
...
// jLabClassPath is the directory that serves as the "root" for external class retrieval. 
 ...
 // This directory and all its subdirectories are searched for both .groovy script files and .class files        
        ...
        static public Vector GroovySciClassPathComponents;
        ...
        static public Vector jartoolboxesForGroovySci;  // load Java classes for Groovy mode from these toolboxes 
    ...
    static public JFrame formulaFrame = null;   // frame that displays symbolic evaluation formulas 
                                                // evaluated from symj with LaTex formatting
    static public JTabbedPane formulaPane = null;  // the pane on which the LaTex formula icon is drawn
  ...
  static public DataOutputStream     writer = null;
    ...
    static public String buildTitle() {
      String mainFrameTitle =        "BioGroovyLab based on Groovy "+org.codehaus.groovy.util.ReleaseInfo.getVersion()+
...
if (useAlwaysDefaultImportsProp != null)
 ...
 if (GlobalValues.gLabMainFrame != null)
       ...
       String rsizeXstr = settings.getProperty("rwidthProp");
        ...
        String jLabConsFontName = settings.getProperty("jLabConsFontNameProp");
        if (jLabConsFontName==null) jLabConsFontName= GlobalValues.jLabConsoleFontName;  
        String jLabConsFontSize = settings.getProperty("jLabConsFontSizeProp");
        if (jLabConsFontSize==null)  jLabConsFontSize= GlobalValues.jLabConsoleFontSize;
        GlobalValues.jLabConsoleFontName = jLabConsFontName;
        GlobalValues.jLabConsoleFontSize = jLabConsFontSize;
...
// pass properties from the gLab workspace structures to the settings Property String to 
    public static void passPropertiesFromWorkspaceToSettings(Properties settings)
     ...
     settings.setProperty("paneFontSizeProp", String.valueOf(paneFontSize)); 
        ...
        settings.setProperty("jLabConsFontNameProp", String.valueOf(gLabMainFrame.jLabConsole.getFont().getName()));
        settings.setProperty("jLabConsFontSizeProp", String.valueOf(gLabMainFrame.jLabConsole.getFont().getSize()));
