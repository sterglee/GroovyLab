...
public class CalculusToolbar  extends JPanel {
        JButton bqadrat, bintegral, btricub, breccof, bjacobnnf, bjacobnmf, bjacobnbndf;
        
    public CalculusToolbar() {
        JPanel basicCalculusPanel = new JPanel();
        
        bqadrat = new JButton("qadrat");
        bqadrat.setToolTipText("Run the Java example within the jExecLab Editor with F5");
       ...
       if (GlobalValues.useSystemBrowserForHelp==false) {
        ...
        bintegral.setToolTipText("Run the Java example within the jExecLab Editor with F5");
        ...
        btricub.setToolTipText("Run the Java example within the jExecLab Editor with F5");
        ...
        breccof.setToolTipText("Run the Java example within the jExecLab Editor with F5");
