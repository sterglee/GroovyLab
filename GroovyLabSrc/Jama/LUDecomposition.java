 ...
 * ------------------------ */
   ...
   */
   ...
   public LUDecomposition (jMatrix A) {
 ...
 * ------------------------ */
   ...
   */
   ...
   public double det () {
      if (m != n) {
         throw new IllegalArgumentException("jMatrix must be square.");
      }
   ...
   */
   ...
   public jMatrix solve (jMatrix B) {
      ...
      if (!this.isNonsingular()) {
         throw new RuntimeException("jMatrix is singular.");
      }

      // Copy right hand side with pivoting
      int nx = B.getColumnDimension();
      jMatrix Xmat = B.getMatrix(piv,0,nx-1);
