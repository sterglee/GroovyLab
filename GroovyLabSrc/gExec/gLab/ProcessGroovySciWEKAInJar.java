...
public class ProcessGroovySciWEKAInJar  extends JFrame {
...
*/
   ...
   public ProcessGroovySciWEKAInJar(String jarFile)
   {
      setTitle("GroovySci WEKA Examples -- Copy & Paste in editor  ");
      ...
      examplesLabel.setText("Selected WEKA GroovySci example: "); 
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".weka-gsci")) 
