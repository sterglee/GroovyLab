...
GlobalValues.myGEdit = new gLabEditor("Untitled", true);
    ...
    // GlobalAutoCompletion.initAutoCompletion();
        ...
        if (GlobalValues.jshell == null) {
            GlobalValues.jshell = JShell.create();
           ...
           GlobalValues.jshell.addToClasspath(JavaGlobals.groovyJarFile);
     ...
     //     GlobalValues.srcAnalyzer = new jdk.jshell.SourceCodeAnalysisImpl(GlobalValues.jshell);
        //   GlobalValues.jshell.eval(GlobalValues.basicGlobalImports);
          ...
          System.out.println("appending to JShell classpath toolboxes of DefaultToolboxes folder:  "+defaultToolboxesFolder);
           ...
           for (int f=0; f < numFiles;  f++) {
               String currentFileName = toolboxesFolderFiles[f].getAbsolutePath();
                  ...
                  if (currentFileName.endsWith(".jar")) {
                   ...
                   System.out.println("appending to JShell classpath from defaultToolboxes folder toolbox: "+currentFileName);
              }  // endsWith("jar")
         ...
         GlobalValues.jshell.onSnippetEvent(gLab::snippetEventHandler);
