...
public class ProcessGroovySciInJar  extends JFrame {
...
*/
   ...
   public ProcessGroovySciInJar(String jarFile)
   {
      setTitle("GroovySci Examples -- Copy & Paste in editor  ");
      ...
      examplesLabel.setText("Selected GroovySci example: "); 
