...
public class ProcessGroovySciPlotsInJar   extends JFrame {
...
*/
   ...
   public ProcessGroovySciPlotsInJar(String jarFile)
   {
      setTitle("GroovySci Plots  Examples -- Copy & Paste in Groovy  mode ");
      ...
      examplesLabel.setText("Selected GroovySci Plot example: ");
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".plots-gsci") ) 
