 ...
 */ 
public class DoubleMatrix extends GroovyObjectSupport implements Serializable   {
...
final public void   putAt(int row, int col, double value)  { 
 ...
 final public DoubleMatrix irand() {
  ...
  final  public DoubleMatrix  map(groovy.lang.Closure c) {
    double [] dm = new double[rows*columns];
    
      for (int elem = 0; elem < rows*columns; elem++)
          dm[elem] = (double)c.call(data[elem]);
