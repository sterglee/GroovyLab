...
public class ProcessGroovyInJar   extends JFrame {
...
*/
   ...
   public ProcessGroovyInJar(String jarFile)
   {
      setTitle("Groovy  Examples -- Copy & Paste in Groovy  mode ");
      ...
      examplesLabel.setText("Selected Groovy  example: ");
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".groovy") && nameOfEntry.indexOf("groovyExamples" ) != -1) 
