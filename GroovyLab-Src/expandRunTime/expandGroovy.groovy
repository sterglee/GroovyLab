...
import  groovySci.math.array.Mat1D;   // Mat1D class
...
// Number + Mat1D
Number.metaClass.plus = {
    Mat1D m -> // the input Mat1D
      ma = m.plus(delegate) ;// perform Mat1D + Number instead
    ma   // return value
}
...
groovySci.math.array.Matrix   mat ->
  ...
  tomat = new groovySci.math.array.Matrix(delegate)
  res = tomat.multiply(mat)
     res 
}   
...
// double [][] * double [][] -- replaced by openblas
/* 
  double [][].metaClass.multiply = 
  { 
double [][] v2 ->
 ...
 */  
// double [][] * Matrix  -- replaced by openblas
/*double [][].metaClass.multiply = 
  { 
