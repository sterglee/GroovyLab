...
public class ProcessGroovySciWaveletsInJar  extends JFrame {
...
*/
   ...
   public ProcessGroovySciWaveletsInJar(String jarFile)
   {
      setTitle("GroovySci Wavelet Examples -- Copy & Paste in editor  ");
      ...
      examplesLabel.setText("Selected Wavelet GroovySci example: "); 
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".wav-gsci")) 
