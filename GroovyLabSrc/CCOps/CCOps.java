...
public class CCOps
{
    static
    {
        if (GlobalValues.hostIsWin64 || GlobalValues.hostIsLinux64 || GlobalValues.hostIsFreeBSD )  {
        String WinthreadsLib = "pthreadVC2.dll";   // this library is installed at the ./lib GroovyLab folder
   
        String libName = "CCOps.so";  // assume  Linux
