 ...
 * ------------------------ */
   ...
   */
   ...
   public CholeskyDecomposition (jMatrix Arg) {
 ...
 * ------------------------ *\
   ...
   *\
   ...
   public CholeskyDecomposition (jMatrix Arg, int rightflag) {
      // Initialize.
      double[][] A = Arg.getArray();
   ...
   */
   ...
   public jMatrix solve (jMatrix B) {
      if (B.getRowDimension() != n) {
         throw new IllegalArgumentException("jMatrix row dimensions must agree.");
      }
      if (!isspd) {
         throw new RuntimeException("jMatrix is not symmetric positive definite.");
      }
