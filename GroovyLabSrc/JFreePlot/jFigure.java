...
import JFreePlot.jPlot.AxisEnum;
...
public static String jplot(double [][]x, Paint color, Shape marker, float [] style, String legend)  {
 ...
 public static void jtitle( String title ) {
  ...
  public static void jlineVisibility(int lineIndex,
   ...
   currentPlot.setLineVisibility(lineIndex, isLineVisible, isShapeVisible);
    ...
    public static void jlineVisibility(String lineId,
                                  boolean isLineVisible,
                                  boolean isShapeVisible) {
        if (currentPlot == null)      currentPlot = jfigure();
...
// close an explicitly requested figure id
   ...
   public static String[] jplot(Matrix  x)  {
    if (currentPlot == null)      currentPlot = jfigure();
  return  currentPlot.jplot(x.getv());
}

    public static String[] jplot(Matrix x, Matrix y) {
   if (currentPlot == null)      currentPlot = jfigure();
   return currentPlot.jplot(x.getv(), y.getv());
        }
        
  public static String[] jplot(Matrix  x, String lineSpec, Object... args) {
        if (currentPlot == null)       currentPlot = jfigure();
        double [] xv = x.getv();
        int len = xv.length;
    double [] ax = new double[len];
    for (int k=0; k<len; k++)
        ...
        return currentPlot.jplot(ax, xv, lineSpec, args);
    }
  
    public static String[] jplot(double x[], Matrix  y, String lineSpec, String legend, Object... args) {
        if (currentPlot == null)       currentPlot = jfigure();
   return currentPlot.jplot(x, y.getv(), lineSpec, legend, args);
    } 
   
public static String[] jplot(Matrix  x, Matrix  y, String lineSpec, String legend, Object... args) {
        if (currentPlot == null)      currentPlot = jfigure();
   return currentPlot.jplot(x.getv(), y.getv(), lineSpec, legend, args);
    } 

public static String[] jplot(Matrix  x, Matrix  y, String lineSpec, Object... args) {
        if (currentPlot == null)      currentPlot = jfigure();
   return currentPlot.jplot(x.getv(), y.getv(), lineSpec, "X-Y Plot", args);
    } 

public static String[] jplot(Matrix  x, double []  y, String lineSpec, String legend, Object... args) {
        if (currentPlot == null)      currentPlot = jfigure();
   return currentPlot.jplot(x.getv(), y, lineSpec, legend, args);
    } 

public static String jplot(Matrix  x,  Paint color, Shape  marker, float [] style,  String legend) {
