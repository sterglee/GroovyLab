...
public class LatexLabel implements Plotable {
	...
	public LatexLabel(String l, Color col, double... c) {
		label = l;
		coord = c;
		color = col;
	}
	public LatexLabel(String l, double... c) {
	 ...
	 * show coord itself
	 */
	public LatexLabel(double... c) {
		this(coordToString(c), AbstractDrawer.DEFAULT_COLOR, c);
	}

	public LatexLabel(String l, Color col, Font f,  double... c) {
		label = l; 	coord = c;	color = col; font = f;
	}

	public LatexLabel(String l, Font f, double... c) {
		this(l, AbstractDrawer.DEFAULT_COLOR, f, c);
	}

	
	public LatexLabel(Font f, double... c) {
