package groovySci.math.array.util;
...
* @return A double.
 ...
 N = 2000; values = new double[N]
 for (k in 0..N-1)
   values[k] = groovySci.math.array.util.Random.chi2(4)
 plot(values)
...
N = 2000; values = new double[N]
 for (k in 0..N-1)
   values[k] = groovySci.math.array.util.Random.logNormal(2, 3)
 plot(values)
...
N = 2000; values = new double[N]
 for (k in 0..N-1)
   values[k] = groovySci.math.array.util.Random.exponential(3)
 plot(values)
