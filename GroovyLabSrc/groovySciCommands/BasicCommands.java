...
// display the LaTex formula graphically
             ...
             org.scilab.forge.jlatexmath.TeXIcon  ticon = formula.createTeXIcon(TeXConstants.STYLE_DISPLAY, FONT_SIZE_TEX, TeXConstants.UNIT_PIXEL, 80,  TeXConstants.ALIGN_LEFT);
                 ...
                 GlobalValues.formulaFrame = new JFrame("Formula Frame");
                 GlobalValues.formulaFrame.setSize(400,100);
           
             GlobalValues.formulaPane = new JTabbedPane();
             GlobalValues.formulaPane.addTab("  ", ticon, null);
              
              GlobalValues.formulaFrame.add(GlobalValues.formulaPane);    
           
           GlobalValues.formulaFrame.setVisible(true);
